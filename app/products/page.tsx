        ...
        <Container>
          <Section>
            <div className="text-center max-w-4xl mx-auto py-12 sm:py-16 md:py-20 lg:py-32 px-4 sm:px-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight animate-fade-in-up" style={{ color: '#00827B' }}>
                Build the future of open source, so you can build your success.
              </h1>
              <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg font-light leading-relaxed animate-fade-in-up delay-200 px-2" style={{ color: '#00827B' }}>
      ...
      <div className="py-4 sm:py-6 lg:py-8 bg-white px-4 sm:px-6">
        <Container>
          <div className="w-full max-w-full sm:max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto lg:mx-0 lg:mr-auto animate-on-scroll animate-slide-in-left-scroll" data-animate="bounty-pay">
            <div className="rounded-xl lg:rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24" style={{ backgroundColor: '#D4F6F4' }}>
              <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-12 items-center">
                ...
                <div className="flex-1 text-center lg:text-left order-1 lg:order-2 w-full">
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light mb-3 sm:mb-4 md:mb-6 lg:mb-8 xl:mb-10 tracking-wider flex items-center gap-2 sm:gap-3 justify-center lg:justify-start flex-wrap" style={{ color: '#00827B' }}>
                    BountyPay
                    <span className="text-[10px] sm:text-xs px-1.5 py-0.5 rounded-full bg-white/50 backdrop-blur-sm font-normal mt-1 sm:mt-2.5" style={{ color: '#00827B' }}>
                      Alpha
                    </span>
                  </h2>
                  <p className="text-xs sm:text-sm md:text-base font-light leading-relaxed mb-4 sm:mb-6 md:mb-8 lg:mb-10 px-2 sm:px-0" style={{ color: '#00827B' }}>
