...
export default function TeamPage() {
  return (
    <>
      ...
      <Container>
        <Section>
          <h2 className="text-2xl font-light text-ink mb-8">Our Team</h2>
      ...
      <Container>
        <Section>
          <div className="rounded-2xl border border-black/5 p-8 bg-white">
            <h2 className="text-2xl font-light text-ink mb-6 text-center">Connect With Us</h2>
            <div className="flex justify-center gap-8">
              {socials.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 text-ink/60 hover:text-ink transition-colors group"
                  aria-label={social.name}
                >
                  <div className="p-3 rounded-full border border-black/5 group-hover:border-black/10 transition">
                    {social.icon}
                  </div>
